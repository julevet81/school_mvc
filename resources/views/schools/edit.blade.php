...
@section('content')
    <div class="container mx-auto px-4 py-6 max-w-3xl">
        ...
        <div class="bg-white rounded-xl shadow p-6">
            <h1 class="text-xl font-bold text-gray-800 mb-6">{{ __('schools.edit') }}</h1>
            <form method="POST" action="{{ route('schools.update', $school) }}" novalidate>
                @csrf @method('PUT')
                @include('schools._form', ['school' => $school, 'timezones' => $timezones])
